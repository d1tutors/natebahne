...
function LoaderGate() {
    ...
    // Skip the loader if arriving via browser back/forward navigation
    if ("TURBOPACK compile-time truthy", 1) {
        try {
        ...
        // Also handle BFCache restore where pageshow.persisted is true
        const onPageShow = (e)=>{
            if (e.persisted) {
                window.__APP_LOADER_DONE__ = true;
                document.dispatchEvent(new CustomEvent("app-loader-complete"));
...
//# sourceMappingURL=src_components_e7482980._.js.map